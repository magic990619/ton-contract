...
async function deploy() {
  ...
  // open wallet v3r2 (notice the correct wallet version here)
  const mnemonic = "human pistol whisper imitate quantum book sugar setup attend horror lens memory size pulp medal tide chapter chest custom clean rather evolve raw forward";
